...
<html lang="pl" >
      ...
      <body>
            <?php
                  //opcja wylogowania
            	echo "<p style='margin-left:60%'>Witaj ".$_SESSION['user'].'! <a href="logout.php">Wyloguj się!</a> &nbsp;&nbsp; <a href="index.php">Strona Główna</a> &nbsp;&nbsp;<a href="history.php">Historia Wypożyczeń</a></p>';
